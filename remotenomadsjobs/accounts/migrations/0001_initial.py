...
import remotenomadsjobs.accounts.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('user', 'User'), ('company', 'Company')], max_length=10, null=True)),
            ...
            managers=[
                ('objects', remotenomadsjobs.accounts.models.AppUserManager()),
            ],
        ),
        migrations.CreateModel(
